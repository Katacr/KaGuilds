...
**用法**:
```bash
/kg admin bank #123 add 1000    # 添加 1000 金币
/kg admin bank #123 remove 500    # 移除 500 金币
/kg admin bank #123 set 500    # 设置为 500 金币
/kg admin bank #123 see    # 查看当前余额
/kg admin bank #123 log    # 查看银行日志
```
...
**用法**:
```bash
/kg admin exp #123 add 100     # 增加 100 经验
/kg admin exp #123 set 500     # 设置为 500 经验
/kg admin exp #123 remove 50   # 减少 50 经验
```
